...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2023 a las 13:36:07
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `actualizarColumnaEdad`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizarColumnaEdad` ()   BEGIN
	DECLARE fecha DATE;
	DECLARE idU INT;
...
(1220, 'andrea suarez', '2001-02-11', 22),
(1333, 'marta cruz', '1986-10-18', 37),
(17820, 'felipe pliorez', '2003-01-11', 20),
(23220, 'juan camargo', '1999-09-01', 24);
